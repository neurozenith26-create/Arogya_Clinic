 ...
 *
 * `autoPlay` makes the video play muted + looped as soon as it appears.
 * Otherwise we render a poster image with a centered play button, and the
 * source is only attached when the user clicks.
 */
